...
import { Flower2, SearchX, Home } from "lucide-react";
...
export default function GiftNotFound() {
  return (
    <div className="relative min-h-screen overflow-x-clip bg-background pb-[72px] md:pb-0">
      <GiftPageHeader productName="" productPrice={0} productId="not-found" />
      <div className="relative flex min-h-[60vh] flex-col items-center justify-center overflow-hidden px-6 text-center">
        ...
        >
          <motion.div
            ...
            className="mx-auto grid h-20 w-20 place-items-center rounded-3xl bg-brand-soft text-brand shadow-lift dark:bg-rose-950/50 dark:text-rose-300"
          >
