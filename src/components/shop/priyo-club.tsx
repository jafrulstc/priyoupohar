...
const TIER_META: Record<string, { icon: typeof Crown; blurb: string }> = {
  PRIYO100: { icon: Crown, blurb: "₹100 flat off your next order" },
...
export default function PriyoClub() {
  ...
  return (
    <section id="priyo-club" className="relative scroll-mt-24 overflow-hidden py-16 md:py-24">
